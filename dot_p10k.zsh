# Generated by Powerlevel10k configuration wizard on 2026-05-17 at 20:11 CEST.
...
() {
  ...
  # Fix extra space on the right side prompt
  typeset -g ZLE_RPROMPT_INDENT=0

  # Fix inconsistency between icons
  ...
  #################################[ user_icon: identificador de usuario ]##################################
